...
export default function SubsectionCard({
  ...
  useEffect(() => {
    console.debug("Subsection image resolution:", {
      sectionSlug,
  ...
  return (
    <Link
      ...
      className="group relative block overflow-hidden rounded-2xl border border-[#E7F3E9] bg-[#F8FCF8] shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg active:scale-[0.98]"
    >
      ...
      <div className="absolute inset-x-0 bottom-0 border-t border-[#E7F3E9] bg-[#F8FCF8]/90 p-4 backdrop-blur-[1px] sm:p-5">
        <p className="font-serif text-base font-semibold text-[#2F5E3F]">
          {subsection.name}
        </p>
        {subsection.description && (
          <p className="mt-1 text-sm text-[#557562] line-clamp-2">
            {subsection.description}
          </p>
        )}
      </div>
