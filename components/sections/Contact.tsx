...
export default function Contact() {
  return (
    <section className="py-20 sm:py-24 bg-[#EAF8EC] border-t-2 border-[#6FCB8C]">
      <div className="px-4 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div className="text-center md:text-left">
            ...
            <p className="text-lg text-[#5C7A66] mb-12 max-w-2xl leading-relaxed">
          ...
          <div className="order-first md:order-last">
            <Image 
              src="/Fotos/Dama_elegante2.jpeg" 
              alt="Variedades Zapata" 
              width={600} 
              height={400} 
              className="rounded-3xl border border-[#DCEFDD] w-full object-cover"
            />
          </div>
        </div>
      </div>
