  ...
  return (
    <section className="relative min-h-[75vh] flex items-center justify-center bg-[#FAFCF9] overflow-hidden">
      ...
      <a
        ...
        className="fixed bottom-5 right-5 z-40 inline-flex items-center gap-3 rounded-full border border-[#25D366]/20 bg-white px-4 py-3 text-[#0F2A1A] shadow-[0_16px_40px_rgba(37,211,102,0.22)] ring-1 ring-white/70 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_48px_rgba(37,211,102,0.3)]"
      ...
      >
        ...
        <span className="pr-1 text-sm font-semibold">WhatsApp</span>
      </a>
    </section>
  )
}
