...
export default function Navbar() {
  ...
  return (
    <>
      <header className="fixed top-0 bottom-0 sm:bottom-auto inset-x-0 z-50 bg-white/85 backdrop-blur-xl border-b border-[#DCEFDD] shadow-sm transition-all duration-300">
