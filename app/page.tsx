  ...
  return (
    <div className="px-4 py-6 sm:py-8 max-w-7xl mx-auto">
      <div className="mb-8 animate-fade-in">
        <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-green-900">Nueva colección</h1>
        <p className="text-green-600 text-base mt-2">Encuentra tu estilo</p>
      </div>
      <section className="mb-10">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg sm:text-xl font-semibold text-green-800">Categorías</h2>
        </div>
      ...
      {(loading || featured.length > 0) && (
        <section className="animate-fade-in" style={{ animationDelay: '300ms' }}>
          <h2 className="text-lg sm:text-xl font-semibold text-green-800 mb-4">Destacados</h2>
